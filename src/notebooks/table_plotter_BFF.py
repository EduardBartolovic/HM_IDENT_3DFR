...
print("\\cline{5-8}")
print("& \\textbf{Only} & \\textbf{Concat} & \\textbf{Pooling} & "
...
print("\\hline")
print("\\end{tabular}")
print("\\caption{" + ("Absolute MRR values" if mode == "absolute" else "Absolute MRR gains") + " of multiview strategies compared to single-front view on the 3D-BFF dataset. Blue marks the best, orange the worst MV method.}")
print("\\label{tab:???}")
print("\\end{table}")
