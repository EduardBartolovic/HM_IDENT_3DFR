...
from src.backbone.vit import get_vit_model


class MultiviewVitLF(nn.Module):
...
def vit_mv_lf(device, aggregators):
    return MultiviewVitLF(device, aggregators, get_vit_model)
