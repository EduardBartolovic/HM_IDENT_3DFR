...
from src.preprocess_datasets.preprocess_video import analyse_video_vox, analyse_frames_ytf


def preprocessing():
    root = "F:\\Face\\data\\dataset10\\"
    folder_root = root+"ytf_aligned_images_DB"
    dataset_output_folder = root+"test_vox2train_lc8"
    ...
    print("##### Analyse Video ##############")
    print("##################################")
    analyse_frames_ytf(folder_root, "analysis", model_path_hpe, face_detect_model_root, device, batch_size=batch_size, keep=True, max_workers=16, face_confidence=0.6)
