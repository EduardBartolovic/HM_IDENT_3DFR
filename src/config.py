...
configurations = {
    1: dict(
        ...
        RUN_NAME= 'EXP7-rgbd_bellus-39T_25P-enc_512-ArcFace-FocalLoss-112_112-batchsize_32-epochs25-ResNetRGBD_50',  # experiment name
        ...
        BACKBONE_NAME='ResNetRGBD_50',  # support: ['ResNet_50', 'ResNet_101', 'ResNet_152', 'IR_50', 'IR_101', 'IR_152', 'IR_SE_50', 'IR_SE_101', 'IR_SE_152']
